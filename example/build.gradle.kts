plugins {
  ...
  id("org.metaborg.devenv.spoofax.gradle.langspec") version "0.1.8" apply false
  id("org.metaborg.devenv.spoofax.gradle.project") version "0.1.8" apply false
//  id("org.metaborg.spoofax.gradle.project") version "0.4.7" apply false
