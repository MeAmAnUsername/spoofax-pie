...
public class EvaluationResult implements Serializable {
    ...
    private List<Row> getRows() {
        final Row[] rows = {
            ...
            RowProducer.ofIntFunction("PIE DSL lines excluding libraries, including layout" , result -> result.projectCounts.pieCounts.linesIncludingLayout-result.projectCounts.pieLibraryCounts.linesIncludingLayout),
            RowProducer.ofIntFunction("PIE DSL lines including libraries, excluding layout" , result -> result.projectCounts.pieCounts.linesExcludingLayout),
            RowProducer.ofIntFunction("PIE DSL lines excluding libraries and layout" , result -> result.projectCounts.pieCounts.linesExcludingLayout-result.projectCounts.pieLibraryCounts.linesExcludingLayout),
            RowProducer.ofIntFunction("total lines including libraries and layout" , result -> result.projectCounts.javaCounts.linesIncludingLayout+result.projectCounts.pieCounts.linesIncludingLayout),
